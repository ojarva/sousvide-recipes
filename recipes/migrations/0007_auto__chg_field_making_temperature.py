...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Making.temperature'
        db.alter_column('recipes_making', 'temperature', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Making.temperature'
        db.alter_column('recipes_making', 'temperature', self.gf('django.db.models.fields.IntegerField')())
